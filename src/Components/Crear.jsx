      ...
      <div className="w-full h-full bg-white flex flex-col p-5 gap-5">
        <div className="w-full">
          ...
          <header className='flex w-full'>
            <nav className='w-full flex justify-start border-b-1 border-gray-300 mb-2'>
              <a className='mb-2 border-2 rounded-xl p-2 bg-gray-300' href='/dashboard' >Volver</a>
            </nav>
          </header>
            ...
            <div className="flex flex-col gap-5 flex-wrap w-full">
              ...
              <div className="flex flex-row gap-5">
                <Select
                  ...
                  name='tipo'
                  value={entidades?.tipo ? [entidades.tipo] : []}
                  onChange={handleChange}
                >
                  {tipos.map((tipo) => (
