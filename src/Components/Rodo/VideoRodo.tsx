  ...
  return (
    <section className="relative w-full min-h-screen py-32 px-6 md:px-16 flex flex-col justify-between overflow-hidden text-white border-t border-[#111]">
      ...
      <div className="relative z-20 flex-1 flex items-center justify-center pointer-events-none mt-24 lg:mt-32">
        <FadeIn>
          <h2 className={`text-[14vw] sm:text-[11vw] md:text-[8.5vw] text-white leading-[0.95] text-center drop-shadow-2xl ${fraunces.className}`}>
            <span className="block md:inline font-normal">visita</span>
            <span className="hidden md:inline font-light mx-8 text-white/50">/</span>
            <em className="block md:inline italic text-[#FFA500] font-light">Rodo Bulacio</em>
          </h2>
        </FadeIn>
      </div>
